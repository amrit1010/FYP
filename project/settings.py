...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Global static files folder
]

# Path where static files will be collected when running `collectstatic`
...
MAINTENANCE_MODE_TEMPLATE = "errors/505.html"
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            'hosts': [('localhost', 6379)],  # Matches your Celery Redis setup
        },
    },
}
